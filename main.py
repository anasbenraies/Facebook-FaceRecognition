...
class ReconnaissanceFaciale():
    ...
    #collection des donnes et leurs preparations(encodage) !
    def face_encoding(self):
        for image in os.listdir("Faces"):
            face_image=face_recognition.load_image_file(f'Faces/{image}')
            #etant donné une image , retourne un vecteur de 128 dimension 
            #Pour une image donné le vecteur de 128 dimension est UNIQUE !
        ...
        while True :
            ...
            for (top ,right ,bottom,left) , name in zip(self.face_locations,self.face_names):
                    ...
                    if "Unknown" in name:
                        ...
                        cv.rectangle(frame,(left,bottom-25),(right,bottom),(0,255,0),-1)
